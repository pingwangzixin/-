...
//ip
const configure = {
//	marking : 'http://192.168.9.62:8088/',		//郭
	mark : 'http://198.9.6.137:8080/',		//马
...
export let api = {
	...
	getGradeData : (data) => {
		return $http({
			method : 'get',
			url : configure.mark + 'examPaper/jeuc/api/ea/eaOffice',
			params : data,
	...
	getMarkingList:(data) => {
		return $http({
			method : 'get',
			url : configure.mark + 'examPaper/markingTask/findPage',
			params : data,
